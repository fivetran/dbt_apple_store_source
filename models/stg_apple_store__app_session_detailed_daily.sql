with base as (
    ...
    select * 
    from {{ ref('stg_apple_store__app_session_detailed_daily_tmp') }}
    ...
    select
        {{
            fivetran_utils.fill_staging_columns(
                source_columns=adapter.get_columns_in_relation(ref('stg_apple_store__app_session_detailed_daily_tmp')),
