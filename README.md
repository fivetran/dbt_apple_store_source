# [DEPRECATED] Apple App Store Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_apple_store`](https://github.com/fivetran/dbt_apple_store) instead, which now contains all models previously found here._
